...
public class ModModelPredicateProvider {
    public static void registerModModels() {
        ...
        ModelPredicateProviderRegistry.register(ModItems.DRAGON_ELYTRA, new Identifier("broken"), (stack, world, entity, seed) -> ElytraItem.isUsable(stack) ? 0.0f : 1.0f);
//        ModelPredicateProviderRegistry.register(ModItems.DRAGON_TRIDENT, new Identifier("throwing"), (itemStack, clientWorld, livingEntity, seed) -> livingEntity != null && livingEntity.isUsingItem() && livingEntity.getActiveItem() == itemStack ? 1.0F : 0.0F);
    }
