        ...
        LootTableEvents.MODIFY.register(((resourceManager, lootManager, id, tableBuilder, source) -> {
            if (source.isBuiltin() && DRAGON_ID.equals(id)) {
                LootPool.Builder poolBuilder = LootPool.builder()
                        ...
                        .rolls(ConstantLootNumberProvider.create(ThreadLocalRandom.current().nextInt(ModConfigReader.config.dragon_shards_scales.minimum_fragments, ModConfigReader.config.dragon_shards_scales.maximum_fragments) + 1));
