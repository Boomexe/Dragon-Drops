            ...
            if (!itemStack.isEmpty() || bl) {
                ...
                if (!((double)f < 0.1)) {
                    ...
                    if (!world.isClient) {
                        ...
                        persistentProjectileEntity.setVelocity(playerEntity, playerEntity.getPitch(), playerEntity.getYaw(), 0.0F, f * ModConfigReader.config.dragon_bow.speed, ModConfigReader.config.dragon_bow.divergence);
                        if (f == 1.0F) {
