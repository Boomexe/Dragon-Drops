...
public class ModItems {
    ...
    public static final Item DRAGON_SCALE = registerItem("dragon_scale",
            new Item(new FabricItemSettings().maxCount(ModConfigReader.config.dragon_shards_scales.scale_stack_size)));
    ...
    public static final Item DRAGON_BOW = registerItem("dragon_bow",
            new DragonBowItem(new FabricItemSettings().maxDamage(ModConfigReader.config.dragon_bow.durability)));

    public static final Item DRAGON_CROSSBOW = registerItem("dragon_crossbow",
            new CrossbowItem(new FabricItemSettings().maxDamage(ModConfigReader.config.dragon_crossbow.durability)));
